function initengahan(){
  ...
  async function pertanyaan(){var { isConfirmed: prtanya } = await swals.fire({title: nama + ' ' + tanya, text: '' + opstanya, imageUrl: '' + fotostiker6.src, confirmButtonText: '' + tompositif,});
    if(prtanya){
        // Jika tombol "Balas" diklik
        menuju(); // Panggil fungsi menuju untuk mengarahkan pengguna ke WhatsApp
    }
    }
